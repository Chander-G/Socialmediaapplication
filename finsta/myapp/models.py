...
class UserProfile(models.Model):
    ...
    following=models.ManyToManyField('self',null=True,related_name='followed_by')
...
class Comments(models.Model):
    user=models.ForeignKey(User,on_delete=models.CASCADE,related_name='postcomments')
